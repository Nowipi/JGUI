...
public class InteractableContainer extends Container implements Interactable {
    ...
    public InteractableContainer(Styling styling, Layout layout, List<Component> children, Runnable interact) {
        super(styling, layout, children);
        this.interact = interact;
    }

    public InteractableContainer(Layout layout, List<Component> children, Runnable interact) {
